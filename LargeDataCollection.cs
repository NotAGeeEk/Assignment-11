...
namespace ConAppAssignment11
{
    ...
    public class LargeDataCollection : IDisposable
    {
        ...
        {
            // Here Initialize the data structure with the initial data
            data = new int[initialData.Length];
            Array.Copy(initialData, data, initialData.Length);
        }

        //It is a  Method to add elements to the collection
        ...
        // It is a Method to remove elements from the collection
        ...
        //This is Method to access elements in the collection by index
