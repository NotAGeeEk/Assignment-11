...
namespace ConAppAssignment11
{
    class Program
    {
        ...
        {
            // Here it Create an instance of the 'LargeDataCollection' class and demonstrate its usage
            ...
            using (LargeDataCollection collection = new LargeDataCollection(initialData))
            {
                ...
                // Here 'Dispose' method will be called automatically after exiting the 'using' block/above block
            }
